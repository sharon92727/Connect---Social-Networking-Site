...
echo"<table align=\"center\" class=\"msgbox\">";
while($row = mysql_fetch_array($result))
{
	...
	$sql2="select * from $table_name3 where `lno`='$s_id'";
	$result2=@mysql_query($sql2,$connection) or die(mysql_error());
	$row2=mysql_fetch_array($result2);
	$sender=$row2['eid'];
	echo "<tr>";
	echo "<td valign=\"top\"><font color=\"#C5E105\"> Name : </font> $sender &nbsp;&nbsp;&nbsp;&nbsp;</td> ";
	echo "<td valign=\"top\" align=\"left\"> <font color=\"#C5E105\"> Message : </font> $s_msg </td>";
	}
?>
    
  <font face="Comic Sans MS, cursive" size="+2"> <center> Inbox </center></font>
