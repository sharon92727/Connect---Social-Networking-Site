...
<li><a href="create_communities.php">create communities</a></li>
    ...
    <div id="site_content">
      <div id="left_content">
        ...
        ?>
        <form id="form1" action="comm_created.php" method="post">
          <div class="form_settings">
            <p><span>Community Name</span><input class="contact" type="text" name="comm_name" /></p>
            <!--p><span>Email Address</span><input class="contact" type="text" name="your_email"  /></p-->
            <p><span>Description</span><textarea class="contact textarea" rows="5" cols="50" name="desc"></textarea></p>
            <p><span>Choose a file to upload as picture</span>
              <input name="uploadedfile" type="file" /></p>
            <p style="line-height: 1.7em;">To help prevent spam, please enter the answer to this question:</p>
            <p><span><?php echo $number_1; ?> + <?php echo $number_2; ?> = ?</span><input type="text" name="user_answer" /><input type="hidden" name="answer" value="<?php echo $answer; ?>" /></p>
            <p style="padding-top: 15px"><span>&nbsp;</span><input class="submit" type="submit" name="Submit" value="Create" /></p>
          </div>
        </form>
      </div>
