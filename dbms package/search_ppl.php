...
//$sql="select * `login` where `eid` = '$search_user'";
$result=mysql_query("select * from `login` where `eid` like '%$search_user%'");
$num=mysql_num_rows($result);
if($num==0)
{
	header("location:user_doesnt_exist_search.php");
}
...
for($i=0;$i<$num;$i++)
{
	...
	echo "<a href=\"friends_profile.php?id2=$row[0]\">$row[1]</a>"; 
	echo "</td>";
	echo "</tr>";
}
...
<?php
	...
	{
		echo "<p><a href='friends_profile.php?id2=$row[1]'>".$row[0]."</a></p>";
	}
?></h1>
</td>
</tr>
