...
<li><a href="create_communities.php">create communities</a></li>
    ...
    <div id="site_content">
      <div id="left_content">
        <h1>Password doesn't match..!! Please Re-enter </h1>
        <?php
        ...
        ?>
        <form id="contact" action="pwd_change.php" method="post">
          <div class="form_settings">
            <p><span>Current Password</span><input class="contact" type="password" name="cur_pwd" /></p>
            <p><span>New Password</span><input class="contact" type="password" name="new_pwd"  /></p>
            <p><span>Confirm Password</span><input class="contact" type="password" name="chk_new_pwd"  /></p>
