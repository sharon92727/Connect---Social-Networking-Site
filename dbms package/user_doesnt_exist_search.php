...
<li><a href="create_communities.php">create communities</a></li>
      ...
      <div id="left_content">
      <form action="search_ppl.php?id=<?php echo $username1;?>" method="post">
...
<tr>
  <td height="9" colspan="3" valign="top"><hr />        </td>
 </tr>
<tr>
  <td height="78" colspan="3" valign="top">
  <h1> <font face="Comic Sans MS, cursive" size="+2"> <center> Sorry..! User doesn't exist.. </center> </font> </h1>
  </td>
</tr>
  <tr>
