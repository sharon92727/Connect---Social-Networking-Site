...
<?php
	$db_name="test";
	$table_name1="edu_info";
	$table_name2="login";
	$userno="lno";
$connection = @mysql_connect("localhost", "root", "") or die(mysql_error());
$db = @mysql_select_db($db_name, $connection) or die(mysql_error());
$id=$_SESSION['id'];
$sql="SELECT * FROM  `edu_info` WHERE  `lno` =  '$id'";
$result = @mysql_query($sql,$connection) or die(mysql_error());
$row= mysql_fetch_row($result);
echo "<p>&nbsp;</p>";
echo"<table align=\"center\" class=\"educationinfo\">";
    echo "<tr>";
	echo "<td valign=\"top\"><font color=\"#C5E105\"> Occupation : </font> $row[1]</td> ";
	echo "</tr>";
	
    echo "<tr>";
	echo "<td valign=\"top\"><font color=\"#C5E105\"> College &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </font> $row[2]</td> ";
	echo "</tr>";
	
	
    echo "<tr>";
	echo "<td valign=\"top\"><font color=\"#C5E105\"> School &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </font> $row[3] </td> ";
	echo "</tr>";
	echo "</table>";
?>
</h1>
